...
public class ReturnItem extends ModItem {
    ...
    //public static final String WAYPOINT_NOT_SET = "text.wilder_horizons.waypoint.waypoint_not_set";
    //public static final String WAYPOINT_FAILED = "text.wilder_horizons.waypoint.waypoint_failed";
    //
    //public ReturnItem(Settings settings) {
    //    super(settings);
    //}
