...
public enum WHArmorMaterials implements ArmorMaterial {
    ...
    LEATHER_GAITERS("gaiters", 5, new int[]{1, 2, 3, 1}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.LEATHER});
    }),
    SHROOMLEATHER_GARMENTS_NEUTRAL("neutral", 5, new int[]{1, 2, 3, 1}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{WHMiscItems.SHROOMLEATHER});
    }),
    SHROOMLEATHER_GARMENTS_FEMME("femme", 5, new int[]{1, 2, 3, 1}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{WHMiscItems.SHROOMLEATHER});
    }),
    SHROOMLEATHER_GARMENTS_MASC("masc", 5, new int[]{1, 2, 3, 1}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{WHMiscItems.SHROOMLEATHER});
    }),
