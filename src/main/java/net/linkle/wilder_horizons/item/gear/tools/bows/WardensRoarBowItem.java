...
public class WardensRoarBowItem extends BowItem {
    public WardensRoarBowItem(Settings settings) {
        super(settings);
    }
        ...
        if (user instanceof PlayerEntity) {
            ...
            if (!itemStack.isEmpty() || bl) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    world.playSound((PlayerEntity)null, playerEntity.getX(), playerEntity.getY(), playerEntity.getZ(), SoundEvents.ENTITY_WARDEN_SONIC_BOOM, SoundCategory.PLAYERS, 3.0F, 0.8F / (world.getRandom().nextFloat() * 0.4F + 1.2F) + f * 0.5F);
