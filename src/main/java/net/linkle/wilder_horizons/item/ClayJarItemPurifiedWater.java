...
public class ClayJarItemPurifiedWater extends FoodItem {

    private boolean isMilk;

    public ClayJarItemPurifiedWater(Settings settings, int hunger, float satMod) {
    ...
    public ClayJarItemPurifiedWater setMilk() {
        isMilk = true;
        return this;
    }
