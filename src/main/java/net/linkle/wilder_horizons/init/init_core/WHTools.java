...
public enum WHTools implements ItemEnum, ToolConstants {
    ...
    OBSIDIAN_MACUAHUITL(new KnifeBase(WHToolMaterials.OBSIDIAN, SWORD_BASE_DAMAGE, KNIFE_BASE_SPEED, BASIC_SETTINGS_RARE_RELIC)),
    LUMBER_AXE(new WoodcutterAxeBase(WHToolMaterials.DIAMOND_EXTENDED, AXE_BASE_DAMAGE, AXE_BASE_SPEED, BASIC_SETTINGS_UNCOMMON_RELIC)),
