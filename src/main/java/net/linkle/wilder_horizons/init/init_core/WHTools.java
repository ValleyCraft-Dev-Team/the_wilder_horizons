...
public enum WHTools implements ItemEnum, ToolConstants {
    ...
    MAKESHIFT_CACTUS_CLUB(new KnifeBase(WHToolMaterials.MAKESHIFT_WOOD, MAKESHIFT_BASED_DAMAGE, KNIFE_BASE_SPEED, BASIC_SETTINGS)),
    ...
    BONE_MISERICORDE(new KnifeBase(WHToolMaterials.DRAGON_TOOTH, SWORD_BASE_DAMAGE, KNIFE_BASE_SPEED, BASIC_SETTINGS_RARE)),
    URCHIN_MACE(new KnifeBase(WHToolMaterials.DRAGON_TOOTH, SWORD_BASE_DAMAGE, KNIFE_BASE_SPEED, BASIC_SETTINGS_RARE)),
    DRAGON_SPEAR(new KnifeBase(WHToolMaterials.DRAGON_TOOTH, SWORD_BASE_DAMAGE, KNIFE_BASE_SPEED, BASIC_SETTINGS_RARE)),
    ILLAGER_AXE(new KnifeBase(WHToolMaterials.DRAGON_TOOTH, SWORD_BASE_DAMAGE, KNIFE_BASE_SPEED, BASIC_SETTINGS_RARE)),
    AMETHYST_SWORD(new KnifeBase(WHToolMaterials.DRAGON_TOOTH, SWORD_BASE_DAMAGE, KNIFE_BASE_SPEED, BASIC_SETTINGS_RARE)),
    IRON_CUTLASS(new KnifeBase(WHToolMaterials.DRAGON_TOOTH, SWORD_BASE_DAMAGE, KNIFE_BASE_SPEED, BASIC_SETTINGS_RARE)),
    DRUID_SICKLE(new KnifeBase(WHToolMaterials.DRAGON_TOOTH, SWORD_BASE_DAMAGE, KNIFE_BASE_SPEED, BASIC_SETTINGS_RARE)),
    SCIMITAR(new KnifeBase(WHToolMaterials.DRAGON_TOOTH, SWORD_BASE_DAMAGE, KNIFE_BASE_SPEED, BASIC_SETTINGS_RARE)),
    MINING_DRILL(new KnifeBase(WHToolMaterials.DRAGON_TOOTH, SWORD_BASE_DAMAGE, KNIFE_BASE_SPEED, BASIC_SETTINGS_RARE)),
