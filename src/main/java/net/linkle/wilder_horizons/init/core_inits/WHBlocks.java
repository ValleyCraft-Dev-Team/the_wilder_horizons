...
public enum WHBlocks implements ItemEnum, BlockEnum {
    ...
    POTTED_GODDESS_LILY(new PotBlock(WHNature.GODDESS_LILY)),
    POTTED_RED_LUPINE(new PotBlock(WHNature.RED_LUPINE)),
    POTTED_YELLOW_LUPINE(new PotBlock(WHNature.YELLOW_LUPINE)),
    POTTED_PINK_LUPINE(new PotBlock(WHNature.PINK_LUPINE)),
