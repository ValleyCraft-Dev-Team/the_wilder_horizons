        ...
        TradeOfferHelper.registerWanderingTraderOffers(1,
                factories -> {
                    ...
                    factories.add(((entity, random) -> new TradeOffer(
                            ...
                            16, 2, 0.05f)));
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.CARVED_PUMPKIN, 8),
                            new ItemStack(Items.EMERALD, 1),
                            16, 2, 0.05f)));
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.GRAY_WOOL, 18),
                            new ItemStack(Items.EMERALD, 1),
                            16, 2, 0.05f)));
                    ...
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.EMERALD, 2),
                            new ItemStack(WHMiscItems.SHROOMLEATHER, 6),
                            16, 2, 0.05f)));
                    factories.add(((entity, random) -> new TradeOffer(
                    ...
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.EMERALD, 1),
                            new ItemStack(WHFishItems.RED_PORGY_BUCKET, 1),
                            16, 2, 0.05f)));
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.EMERALD, 1),
                            new ItemStack(WHFishItems.STONEROLLER_MINNOW_BUCKET, 1),
                            16, 2, 0.05f)));
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.EMERALD, 2),
                    ...
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.EMERALD, 8),
                            new ItemStack(WHArmors.HUNTERS_CAP, 1),
                            16, 2, 0.05f)));
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.EMERALD, 1),
