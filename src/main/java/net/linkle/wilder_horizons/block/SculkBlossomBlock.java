...
public class SculkBlossomBlock extends SporeBlossomBlock {
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        world.addParticle(WHParticles.SCULK_POLLEN, d, e, f, 0.0D, 0.0D, 0.0D);
        ...
        for(int l = 0; l < 14; ++l) {
            ...
            if (!blockState.isFullCube(world, mutable)) {
                world.addParticle(WHParticles.SCULK_POLLEN, (double)mutable.getX() + random.nextDouble(), (double)mutable.getY() + random.nextDouble(), (double)mutable.getZ() + random.nextDouble(), 0.0D, 0.0D, 0.0D);
            }
        }
