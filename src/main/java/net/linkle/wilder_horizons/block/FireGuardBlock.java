...
public class FireGuardBlock extends HorizontalWithWaterBlock {
    ...
    public void appendTooltip(ItemStack itemStack, BlockView world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add( Text.translatable("block.wilder_horizons.fireguard.tooltip").formatted(Formatting.AQUA) );
        tooltip.add( Text.translatable("block.wilder_horizons.fireguard.tooltip_2").formatted(Formatting.AQUA) );
    }
}
