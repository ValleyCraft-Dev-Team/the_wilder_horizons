...
public class WillowPotBlock extends FlowerPotBlock {

    public WillowPotBlock(BlockConvertible content) {
        super(content.asBlock(), Settings.copy(Blocks.POTTED_POPPY).ticksRandomly());
    }
