...
public class DefectiveBlock extends Block {
    ...
    public void appendTooltip(ItemStack itemStack, BlockView world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add( Text.translatable("block.wilder_horizons.defective_spawner.tooltip").formatted(Formatting.GRAY) );
        tooltip.add( Text.translatable("block.wilder_horizons.defective_spawner.tooltip_2").formatted(Formatting.GRAY) );
    }
}
