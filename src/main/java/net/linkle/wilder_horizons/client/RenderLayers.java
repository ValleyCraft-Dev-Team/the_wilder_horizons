...
public class RenderLayers {
    ...
    static void initialize() {
        ...
        put(GOLD_LEAF_MAPLE_DOOR, cullout);
        put(GOLD_LEAF_MAPLE_TRAPDOOR, cullout);
        ...
        put(GOLD_LEAF_MAPLE_SAPLING, cullout);
        put(POTTED_GOLD_LEAF_MAPLE_SAPLING, cullout);
        ...
        put(GOLD_LEAF_MAPLE_LATTICE, cullout);
        ...
        put(HOLLOW_GOLD_LEAF_MAPLE_LOG, cullout);
        ...
        put(GOLD_LEAF_MAPLE_SEED, cullout);
