package net.linkle.wilder_horizons.client.trinket.renderer;
...
public class ArmRenderer implements TrinketRenderer {

    private static final ModelPart ARM;
    
    private final Identifier texture;
    
    /** @param texture file name in wilder_horizons/textures/models/trinket/bracelet */
    public ArmRenderer(String texture) {
        this.texture = Main.makeId("textures/models/trinket/bracelet/"+texture+".png");
    }
    ...
    public void render(ItemStack stack, SlotReference slotReference, EntityModel<? extends LivingEntity> contextModel,
        ...
        if (entity instanceof AbstractClientPlayerEntity player) {
            ...
            ARM.copyTransform(model.leftArm);
    ...
    static {
        ...
        ARM = TexturedModelData.of(model, 64, 32).createModel().getChild(EntityModelPartNames.LEFT_ARM);
    }
}
